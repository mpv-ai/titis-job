...
function render() {
  ...
  const meta = `
    <div class="feed-meta">
      ...
      <p class="feed-updated">Updated Wed, Aug 19 · Tito refreshes twice a day</p>
      <p class="feed-refresh">Refreshed 9:00 AM / 5:00 PM ET</p>
    </div>`;
